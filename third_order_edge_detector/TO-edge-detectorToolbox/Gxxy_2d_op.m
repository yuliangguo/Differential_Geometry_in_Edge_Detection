function Gxxy_2d = Gxxy_2d_op(sigma, dx, dy)
%function Gxxy_2d = Gxxxy_2d_op(sigma, dx, dy)
%
% d^3G/d^2xdy operator with operator shift
%
...
% figure;
% axis([-w w -w w]);
% imagesc([-w:w],[-w:w], Gxxy_2d); colormap gray;
% hold on;
